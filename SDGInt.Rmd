...
```
## FIGURE 3: Plots for Radar Diagrams:
...
#HILL
 radarchart(rad_h, 
           ...
           #defining plot type
           plwd = 2.5,plty = 1,pcol = rgb(141, 160, 203, 150,maxColorValue = 255), pfcol = rgb(141, 160, 203, 75,maxColorValue = 255),
           
           #defining font sizes
           vlcex = 0.7, calcex = 0.8,
...
radarchart(rad_t, 
           ...
           #defining plot type
           plwd = 2.5,plty = 1,pcol = rgb(252, 141, 98, 150, maxColorValue = 255), pfcol = rgb(252, 141, 98, 75, maxColorValue = 255),
...
radarchart(rad_n, 
           ...
           #defining plot type
           plwd = 2.5,plty = 1,pcol = rgb(128, 0, 0, 150, maxColorValue = 255), pfcol = rgb(128, 0, 0, 75, maxColorValue = 255),
...
radarchart(rad_m, 
           ...
           #defining plot type
           plwd = 2.5,plty = 1,pcol = rgb(255, 217, 47, 150,maxColorValue = 255), pfcol = rgb(255, 217, 47, 75,maxColorValue = 255),
...
n_rad_fig
```
#Figure 3: Combining all figures (Radarplot)
```{r}
ggarrange(m_rad_fig, h_rad_fig, t_rad_fig, n_rad_fig, nrow = 2, ncol = 2)
```
