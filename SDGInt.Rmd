...
# test commit Graham Prescott 2021-04-09
...
ggplot(alldat, aes(fill = interaction,y = count, x = indicator, label = scales::percent(count))) + geom_bar(position = "stack", stat = "identity", alpha = 0.8) + 
  scale_fill_manual(values = c("#ffff99" , "#fdc086", "#7fc97f")) +
  theme(axis.text.x = element_text(size = 8)) +
  labs(y = "", x = "SDG 15 Indicators") + 
